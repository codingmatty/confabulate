...
export default function InstallPrompt() {
  useEffect(() => {
    new pwaInstallPrompt('.pwa-install-prompt__container', {
      ...
      show_after: 5 // Show after 5 days
    });
  });
  return (
    <div className="pwa-install-prompt__container">
      <button className="pwa-install-prompt__overlay">Close</button>
      <div className="pwa-install-prompt">
        ...
        <div className="pwa-install-prompt__content">
          <h3 className="pwa-install-prompt__title">Install Confabulate</h3>
          ...
          <p className="pwa-install-prompt__guide">
            Just tap{' '}
            <svg
              className="pwa-install-prompt__guide__icon"
              viewBox="0 0 128 128"
